package com.jinzaofintech.commonlib.view.smartrefresh;
...
public class NormalRefreshHeader extends RelativeLayout implements RefreshHeader {
    ...
    public int onFinish(RefreshLayout layout, boolean success) {
        ...
        mImageViewAni.setImageResource(R.mipmap.lib_ic_loading_success);
    ...
    public void onStateChanged(RefreshLayout refreshLayout, RefreshState oldState, RefreshState newState) {
        switch (newState) {
            ...
            case PullDownToRefresh:
                ...
                mImageViewAni.setImageResource(R.mipmap.lib_ic_loading);
